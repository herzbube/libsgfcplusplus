...
namespace LibSgfcPlusPlus
{
  ...
  public:
    ...
    /// or a positive number. Is thrown if @a messageType is not
    /// SgfcMessageType::FatalError and @e lineNumber or @e columnNumber are
    /// less than 1. Is thrown if @a messageType is SgfcMessageType::FatalError
    /// and @e lineNumber or @e columnNumber are not
