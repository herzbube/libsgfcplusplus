...
namespace LibSgfcPlusPlus
{
  ...
  public:
    ...
    /// generated by SGFC.
    ///
    /// @exception std::invalid_argument Is thrown if the numeric value
    /// underlying @a messageID is not zero or a positive number. Is thrown if
    /// the message type is SgfcMessageType::FatalError and
    /// @e isCriticalMessage is true.
    ///
    ...
    ///
    /// @exception std::invalid_argument Is thrown if the numeric value
    /// underlying @a messageID is not a negative number
    SgfcMessage(
      SgfcMessageID messageID,
      const std::string& messageText);
    ...
    virtual SgfcTextOffset GetLineNumber() const override;
    virtual SgfcTextOffset GetColumnNumber() const override;
