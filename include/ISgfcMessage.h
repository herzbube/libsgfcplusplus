...
namespace LibSgfcPlusPlus
{
  ...
  public:
    ...
    /// @brief Returns the message's identification number. Every message
    /// generated by SGFC has its own unique message ID.
    ///
    /// Consult the SGFC documentation for a list of message IDs. SGFC calls
    /// them "error codes".
    ...
    /// is written.
    ///
    /// @todo Possibly document the effect of the "-c" option.
