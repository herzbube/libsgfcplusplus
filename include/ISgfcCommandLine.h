...
namespace LibSgfcPlusPlus
{
  ...
  public:
    ...
    /// exit codes of SGFC.
    ///
    /// @exception std::runtime_error Is thrown if an SGFC fatal error occurs
    /// during loading or parsing of the SGF file (e.g. the file at the
    /// specified path does not exist, file permissions prevent the file from
    /// being read, etc.).
    ...
    ///
    /// @exception std::runtime_error Is thrown if an SGFC fatal error occurs
    /// during loading or parsing of the temporary SGF file (e.g. the file at
    /// the specified path does not exist, file permissions prevent the file
    /// from being read, etc.).
    ...
    ///
    /// @exception std::runtime_error Is thrown if the file at the specified
    /// path cannot be written for any reason (e.g. the parent folder does not
    /// exist, file permissions prevent the file from being written, etc.).
    ...
    ///
    /// @exception std::runtime_error Is thrown if there is an error related
    /// to handling the temporary file.
