...
namespace LibSgfcPlusPlus
{
  ...
  enum class SgfcPropertyType
  {
    ...
    /// @brief The file format used in the game tree. Property value: Number.
    ///
    ...
    /// @see SgfcGameType.
    GM,
    /// @brief Define the board size. Property value: Either a single Number,
    /// or a composed Number/Number (i.e. "Number:Number").
    ///
    ...
    /// This is a root property.
    SZ,
    /// @brief Define how variations should be shown. Property value: Number.
    ///
    /// This is a root property.
    ///
    ...
    /// type property values in the game tree. Property value: SimpleText.
    ///
    ...
    /// game tree. Property value: Composed SimpleText/SimpleText (i.e.
    ...
    /// points. Property value: List of composed Point/SimpleText (i.e.
    /// "Point:SimpleText").
    ///
    ...
    /// the second point. Property value: List of composed Point/Point (i.e.
    /// "Point:Point").
    ///
    ...
    LN,
    M,
    /// @brief Mark the given points with an "X". Property value: List of
    /// Point.
    ///
    /// Property values must be unique.
    ///
    ...
    /// This is a markup property.
    MA,
    /// @brief Mark the given points with a triangle. Property value: List of
    /// Point.
    ///
    /// Property values must be unique.
    ///
    ...
    /// This is a markup property.
    TR,
    /// @brief Mark the given points with a circle. Property value: List of
    /// Point.
    ///
    /// Property values must be unique.
    ///
    ...
    TB,
    TW,
    /// @brief Mark the given points with a square. Property value: List of
    /// Point.
    ///
    /// Property values must be unique.
    ///
    ...
    /// This is a markup property.
    SQ,
    /// @brief Draw the given points as "selected". Property value: List of
    /// Point.
    ///
    /// Property values must be unique.
    ///
    ...
    /// This is a markup property.
    SL,
    /// @brief Dim (grey out) the given points. Property value: Elist of
    /// Point.
    ///
